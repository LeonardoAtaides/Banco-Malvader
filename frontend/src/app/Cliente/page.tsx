...
import { Eye, EyeOff, LogOut, FileChartColumn, BanknoteArrowUp, BanknoteArrowDown, ArrowLeftRight, ChartCandlestick, ChevronRight } from "lucide-react";
            ...
            <div className="flex justify-center text-[12px]">
                <button onClick={goToInvestimentos} className=" flex justify-between items-center w-90 text-center mt-2 bg-[#012E4B] py-8 px-5 rounded-[10px]">
                    <div className="flex justify-center gap-20">
                        ...
                        <div className="flex-col text-center">
                            <h2>Rendimento</h2>
                            <p className="text-[#42D23A]">{ocultar ? "•••••" : "+ R$ 52,50"}</p>
                        </div>
                    </div>
